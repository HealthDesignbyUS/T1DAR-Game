...
{
    private const int SCENE_BUTTON_SIZE_X = 600;
    private const int SCENE_BUTTON_SIZE_Y = 250;
...
//        "PointToPoint",
        "AnimalFriendsAR_lvl2",
        "AnimalFriendsChooser",
...
//        "ExperimentalMeshOcclusion"
    ...
    private void OnGUI ()
    {
        for (int it = 0; it < m_sceneNames.Length; ++it) {
            ...
            if (GUI.Button (buttonRect, "<size=30>" + m_sceneNames [it] + "</size>")
